...
public class MomentItem {
    ...
    // 构造函数
    public MomentItem(Uri avatar, String username, String tag, String title, String content, Uri picture, Uri video, String address, int likeCount, int commentCount, int starCount) {
